...
public class ChargerStationDetailFragment extends AppCompatActivity {
    Toolbar toolbar;
    TextView textview_title, textview_lat, textview_lon, textview_phone, textview_alert;
    Button button_googlemap, button_alert, buttonMap;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Charger_FragmentEmpty dFragment = new Charger_FragmentEmpty();
        ...
        button_alert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ChargerStationDetailFragment.this);
